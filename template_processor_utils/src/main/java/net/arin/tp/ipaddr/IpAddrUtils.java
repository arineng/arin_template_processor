...
public class IpAddrUtils
{
    ...
    public static byte[] textToNumericFormatV4( String src )
    {
         ...
         *
         * We determine and parse the leading parts, if any, as single byte values in one pass directly into the
         * resulting byte[], then the remainder is treated as a 8-to-32-bit entity and translated into the remaining
         * bytes in the array.
         */
        for ( int i = 0; i < len; i++ )
        {
            ...
            throws UnknownHostException
    {
        if ( addr != null )
        {
            if ( addr.length == 4 )
            {
                return Inet4Address.getByAddress( null, addr );
            }
