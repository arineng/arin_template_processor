...
public class IPV6ReallocateTemplateV4Impl extends ReallocateTemplateV4Impl
{
    public IPV6ReallocateTemplateV4Impl()
    {
    }

    public IPV6ReallocateTemplateV4Impl( String emailTemplate )
    {
