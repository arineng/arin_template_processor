...
public class IPV6ReassignDetailedTemplateV5Impl extends ReassignDetailedTemplateV5Impl
{
    public IPV6ReassignDetailedTemplateV5Impl()
    {
    }

    public IPV6ReassignDetailedTemplateV5Impl( String emailTemplate )
    {
